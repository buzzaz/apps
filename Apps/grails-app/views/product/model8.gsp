			...
			<div>
				<div>
								...
								<!-- Nav -->
										...
										<nav id="nav">
											<ul>
												<li><button class="button" style="font-size:65px;">Pixel 2.0 -- <g:link controller="product" action="model9"><span style="color:#feff00">WEB3 NFT Mind Model 9 >></span></g:link></span></button></li>
												<li><button class="button" style="font-size:65px;"><g:link controller="product" action="model7"><span style="color:#feff00"><< WEB3 NFT Mind Model 7</span></g:link></span></button></li>
						...
						<br><br><br><br>
								...
								Quadrants Programming Interface
