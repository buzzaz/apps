			...
			<div>
				<div>
								...
								<!-- Nav -->
										...
										<nav id="nav">
											<ul>
												<li><button class="button" style="font-size:65px;">Pixel 2.0 -- <g:link controller="product" action="a"><span style="color:#feff00">WEB3 NFT Mind Model 7 >></span></g:link></span></button></li>
												<br><br>
						...
						<div class="12u">
								...
								Pixel 2.0 Application Programming Interface
									...
									<p>Draw a 3D image, Pixel.</p>
									<canvas id='canvasBelgianFlag' class='canvasRoundCorders'></canvas>
									<input id='buttonCreateBelgianFlag' type='button' value='Drawing a dimension ...' onclick="createBelgianFlag('canvasBelgianFlag')">
