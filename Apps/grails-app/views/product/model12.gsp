...
canvas {
	...
	<body class="homepage" onload="startGame()">
				...
				<div>
					...
					<div>
								<!-- Nav -->
										...
										<nav id="nav">
											<ul>
												<li><button class="button" style="font-size:65px;">Pixel 2.0 -- <g:link controller="product" action="a"><span style="color:#feff00">WEB3 NFT Mind Model 12 >></span></g:link></span></button></li>
												<li><button class="button" style="font-size:65px;"><g:link controller="product" action="model11"><span style="color:#feff00"><< WEB3 NFT Mind Model 11</span></g:link></span></button></li>
						...
						<br><br>
								...
								<span style="font-size:45px;">Pixel Game Development - Application Programming Interface - Experience</span>
