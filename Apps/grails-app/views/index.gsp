...
<html>
	<head>
		<meta name="description" content="Pixel 2.0 - JavaScript WEB3 Metaverse NFT Framework" />
<meta name="keywords" content="javascript, web3, metaverse, nft, framework, Books, Publish, Marketing, pdf, text, images, image, video, photo, distribute, distribution, Garments, Art, Clothing, Jewelry, startup, online store, entrepreneur" />
<meta http-equiv="window-target" content="_top" />
<META HTTP-EQUIV="CACHE-CONTROL" CONTENT="PUBLIC">
	<meta http-equiv="content-type" content="text/html;charset=UTF-8" />
	<title>Pixel 2.0 - JavaScript WEB3 Metaverse NFT Framework</title>
					...
					<div class="row">
						...
						<div id="myCarousel" class="carousel slide" data-ride="carousel">
						  ...
						  <div class="carousel-inner">
						    ...
						    <asset:image src="pixel-meta-1.png"/>
						    </div>
						    
						    <div class="item">
						    <asset:image src="pixel-meta-2.png"/>
						    </div>
						    						    
						    <div class="item">
						    <asset:image src="pixel-meta-3.png"/>
						    </div>
						  ...
						  <a class="right carousel-control" href="#myCarousel" data-slide="next">
						    ...
						    <span class="sr-only">Next</span>
								...
								<!-- Nav -->
										<nav id="nav">
											<ul>
												<li><button class="button"><span style="color:#ffffff"><g:link controller="product" action="model1"><span style="color:#feff00;font-size:50px;">Pixel 2.0 Demo - JavaScript WEB3 API Mind Models</span></g:link></span></button></li>
												<br><br>
