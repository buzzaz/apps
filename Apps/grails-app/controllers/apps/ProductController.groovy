...
class ProductController {
	...
	def model3() {
		System.out.println("inside model3")
		log.info "inside model3"
	}
	
	def model4() {
		System.out.println("inside model4")
	...
	def model8() {
		System.out.println("inside model8")
		log.info "inside model8"
	}
	
	def model9() {
		System.out.println("inside model9")
		log.info "inside model9"
	}
	
	def model10() {
		System.out.println("inside model10")
		log.info "inside model10"
	}
	
	def model11() {
		System.out.println("inside model11")
		log.info "inside model11"
	}
	
	def model12() {
		System.out.println("inside model12")
		log.info "inside model12"
	}
	
	def model1() {
		System.out.println("inside model1")
		log.info "inside model1"
	}
